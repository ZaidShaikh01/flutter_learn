...
class Transport extends StatefulWidget {
  ...
  @override
  State<Transport> createState() => _MainscreenState();
}

class _MainscreenState extends State<Transport> {
  ...
  Future<void> getData() async {
    ...
    try {
      Response response = await Dio().get(
          "https://bucketlist-8a6cd-default-rtdb.firebaseio.com/train.json");
